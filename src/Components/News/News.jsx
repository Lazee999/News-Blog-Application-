...
const News = ({ onShowBlogs, blogs, onEditBlog, onDeleteBlog }) => {
    ...
    const handleBookmarkClick = (article, e) => {
        ...
        setBookmarks(prevBookmarks => {
            const updatedBookmarks = prevBookmarks.some(bookmark => bookmark.title === article.title)
        ...
        <div className="news">
            ...
            <div className="news-content">
                    ...
                    {headline && (
                        <div className="headline" onClick={() => handleArticleClick(headline)}>
                            ...
                            <h2 className="heading-title">
                                {headline.title}
                                <i
                                    className={`${bookmarks.some(b => b.title === headline.title) ? 'fa-solid' : 'fa-regular'} fa-bookmark bookmark`}
                                    onClick={(e) => handleBookmarkClick(headline, e)}
                                ></i>
                            </h2>
                        </div>
                    )}
                ...
                <div className="my-blog">
                    ...
                    {showBlogModal && <BlogModal show={showBlogModal} blog={selectedPost} onClose={closeBlogModal} />}
                </div>
